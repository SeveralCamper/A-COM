...
void SimpleFractions::operator+=(const SimpleFractions &other) {
  if (denominator_ == other.denominator_) {
    ...
    if (other.numerator_ != 0 || other.numerator_ != 1) {
      ...
      long long int first_mult = NOK / denominator_,
                    second_mult = NOK / other.denominator_;
...
bool SimpleFractions::operator!=(const SimpleFractions &other) {
  bool res = 0;
  if (this->ConvertToDouble() !=
      ((double)other.numerator_ / (double)other.denominator_)) {
    res = 1;
  }
...
SimpleFractions::SimpleFractions(long long int numerator,
...
long long SimpleFractions::GetNumenator() { return numerator_; }

long long SimpleFractions::GetDenominator() { return denominator_; }
